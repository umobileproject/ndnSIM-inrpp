...
#ifndef NFD_DAEMON_FW_INRPP_STRATEGY_HPP
#define NFD_DAEMON_FW_INRPP_STRATEGY_HPP
 ...
 */
class InrppStrategy : public Strategy
{
public:
  explicit
  InrppStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
