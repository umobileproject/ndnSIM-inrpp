...
#ifndef NDNSIM_HELPER_INRPP_STACK_HELPER_HPP
#define NDNSIM_HELPER_INRPP_STACK_HELPER_HPP
 ...
 */
class InrppStackHelper : boost::noncopyable {
public:
  /**
   * \brief Create a new NdnInrppStackHelper with a default NDN_FLOODING forwarding stategy
   */
  InrppStackHelper();

  /**
   * \brief Destroy the NdnInrppStackHelper
   */
  virtual ~InrppStackHelper();
